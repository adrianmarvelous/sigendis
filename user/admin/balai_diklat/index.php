...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <!-- <a class="btn bg-gradient-primary" href="index.php?pages=input_peminjam">Masukan Peminjam Baru</a> -->
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0" id="example">
                            ...
                            <?php
                            $i = 1;
                            $query_data = $db->prepare("SELECT * FROM sigendis_jadwal_peminjaman ORDER BY tgl_mulai DESC");
                            $query_data->execute();
