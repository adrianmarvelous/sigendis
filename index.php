  ...
  <div class="container-fluid">
      ...
      <div class="d-flex" style="">
          <ul class="navbar-nav me-auto mb-2 mb-lg-3">
              ...
              <li class="nav-item" style="font-size:24px;margin:20px;font-family: 'Anton', sans-serif;">
                  <a class="nav-link" href="?pages=tanggapan">Tanggapan<span class="sr-only"></span></a>
              </li>
              <li class="nav-item" style="font-size:24px;margin:20px;font-family: 'Anton', sans-serif;">
                  <a class="nav-link" href="../sekretariat/login_system/login.php">Login<span class="sr-only"></span></a>
              </li>
          </ul>
      </div>
      </div>
...
<?php 
  ...
  }elseif(htmlentities($_GET['pages']) == "detail_kegiatan"){
  ...
  }elseif(htmlentities($_GET['pages']) == "tanggapan"){
    include "tanggapan/masukan_email.php";
  }elseif(htmlentities($_GET['pages']) == "index_tanggapan"){
    include "tanggapan/index.php";
  }elseif(htmlentities($_GET['pages']) == "detail_tanggapan"){
    include "tanggapan/detail_tanggapan.php";
  }
?>
</div>
